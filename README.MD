...
1. Add `RNAccountKit` Pod to your Podfile
...
3. Add your Facebook credentials to your project's `Info.plist` file
  ```xml
      <plist version="1.0">
        <dict>
          ...
  ...
  ```
4. Done! Now run your project from XCode or with `react-native run-ios` from your terminal
